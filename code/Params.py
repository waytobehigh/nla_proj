...
class Params (object):
    def __init__(self):
        ...
        self.initial_learning_rate = 0.0001 # learning rate for SGD, [exp(-10), 1]
        self.lr_decay = 0.5 # the multiplier to multiply the learning rate every epoch
        ...
        self.num_layers = 392 # number of layers
        ...
        self.dataset = 'add' # dataset name, mnist.[length] where length will overwrite self.time_steps
